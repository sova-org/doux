...
A state variable bandpass filter (TPT/SVF) that attenuates frequencies outside a band around the center frequency. Each filter has its own envelope that modulates the center frequency.
