...
Compilation options: -lang rust -ct 1 -cn DelayPingpongDsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 1
------------------------------------------------------------ */
#[repr(C)]
pub struct DelayPingpongDsp {
	fSampleRate: i32,
	fConst0: F32,
	fConst1: F32,
	fConst2: F32,
...
impl DelayPingpongDsp {
		
	pub fn new() -> DelayPingpongDsp { 
		DelayPingpongDsp {
			fSampleRate: 0,
			fConst0: 0.0,
			fConst1: 0.0,
	...
	pub fn metadata(&self, m: &mut dyn Meta) { 
		...
		m.declare("compile_options", r"-lang rust -ct 1 -cn DelayPingpongDsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 1");
		m.declare("delays.lib/name", r"Faust Delay Library");
		m.declare("delays.lib/version", r"1.2.0");
		m.declare("filename", r"delay_pingpong.dsp");
		m.declare("maths.lib/author", r"GRAME");
		m.declare("maths.lib/copyright", r"GRAME");
		m.declare("maths.lib/license", r"LGPL with exception");
		m.declare("maths.lib/name", r"Faust Math Library");
		m.declare("maths.lib/version", r"2.8.1");
		m.declare("name", r"delay_pingpong");
	...
	pub fn init(&mut self, sample_rate: i32) {
		DelayPingpongDsp::class_init(sample_rate);
	...
	pub fn build_user_interface_static(ui_interface: &mut dyn UI<FaustFloat>) {
		ui_interface.open_vertical_box("delay_pingpong");
	...
	pub fn compute(
		...
		for (((input0, input1), output0), output1) in zipped_iterators {
			...
			let mut fTemp1: F32 = F32::max(0.0, F32::min(0.95, self.fRec2[0]));
			let mut fTemp2: F32 = 0.5 * (*input0 + *input1) + fTemp1 * self.fRec1[1];
			self.fVec0[(self.IOTA0 & 65535) as usize] = fTemp2;
			let mut fTemp3: F32 = fSlow1 + self.fConst3 * self.fRec3[1];
			self.fRec3[0] = (if (F32::abs(fTemp3) > 1.1754944e-38) as i32 != 0 {fTemp3} else {0.0});
			let mut fTemp4: F32 = F32::max(1.0, F32::min(65534.0, self.fRec3[0]));
			...
			let mut fTemp12: F32 = fTemp1 * self.fRec0[1];
...
impl FaustDsp for DelayPingpongDsp {
	type T = FaustFloat;
